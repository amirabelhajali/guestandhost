...
class AnnonceController extends Controller
{
    ...
    function afficherUneAnnonceAction(Request $req)
    {
        ...
        //$annonce = $em->getRepository('MyAppUserBundle:Annonce')->find($a);
        $user = $em->getRepository('MyAppUserBundle:User')->find($this->getUser()->getId());
    ...
    {
        return
 $this->render('MyAppUserBundle:Annonce:autoCompleteAdress.html.twig');
...
echo ' aaaaaaaaaaaaaaaaaaa';
    ...
    function AfficherAction(Request $req)
    {
        ...
        return $this->render('MyAppUserBundle:Annonce:autoCompleteAdress.html.twig',array('f'=>$form->createView(),'m'=> $classes));
    }
...
//            }
    ...
    function afficherAnnoncePropositionAction(Request $request,$id_demande)
    {
        ...
        return $this->render('MyAppUserBundle:Annonce:proposition.html.twig', array('pagination' => $pagination,'m' => $annonce,'id_demande'=>$id_demande));
